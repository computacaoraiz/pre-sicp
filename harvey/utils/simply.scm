...
;; Como a MIT Scheme 11.2 inclui aspas nas mensagens de erro, a definição
;; do ERROR-PRINTFORM precisa ser alterada, conforme as instruções da
;; página 511 do livro:
(define whoops
  (let ((string? string?)
...
;; MIT Scheme 11.2 já tem RANDOM, então esta definição não é necessária,
;; conforme as intruções na página 511 do livro:
;;(define random
